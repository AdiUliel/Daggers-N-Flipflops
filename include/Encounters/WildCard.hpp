...
public:
    void run(unique_ptr<Character>& player) override {
        cout << "Walking is hard, isn't it? You tripped over your own feet and found... something.\n";
        ...
        if (roll == 1) {
            ...
            if (choice == "y" || choice == "Y") {
                if (player->get_coins() >= 500) {
                    ...
                    cout << "Immidietely you feel like you gotta go to the toilet... SOMETHING is happening.\n";
                    change_player_class(player);
                } else {
                    cout << "Insufficient funds. In other words - Your'e broke son!\n";
                    cout << "The crazy old man pulls out a live baby kangoroo out of his pants, and starts eating it as he walks away.\n";
                    cout << "It screans for its life.\n";
                }
            } else {
